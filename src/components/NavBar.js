...
const solutions = [
  ...
  { name: 'Brickz', description: "Brick breaker clone but added upgrades.", href: '#', icon: ShieldCheckIcon },
  {
    name: 'Marioz',
...
const callsToAction = [
  { name: 'Watch Demos', href: '#', icon: PlayIcon },
  { name: 'Upcoming Releases', href: '#', icon: ForwardIcon },
]
const resources = [
  {
    name: 'Help Center',
